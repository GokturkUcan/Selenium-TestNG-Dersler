...
public class TestBaseRapor {
    ...
    //Method[1] Test işlemine başlamadan hemen önce (test methodundan önce değil, tüm test işleminden önce)
    ...
    public void setUpTest() {
        ...
        String filePath = System.getProperty("user.dir") + "/test-reports/Report"+date+".html";
        ...
        extentReports.setSystemInfo("Automation Engineer", "Moy Maytie");
    ...
    //Method[2] Her test methodundan sonra eğer testte hata varsa, ekran görüntüsü alıp rapora ekliyor
    ...
    //Method[3] Raporlandırmayı sonlandırmak icin
